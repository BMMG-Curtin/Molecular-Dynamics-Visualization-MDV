...
namespace CurtinUniversity.MolecularDynamics.Model.FileParser {
    ...
    /// </summary>
    public class XTCTrajectoryParser {
        ...
        private static int getInt32(BinaryReader reader) {
            ...
            try {
                ...
                throw new FileParseException("Error reading int32");
            }
        }
        ...
        private static float getFloat32(BinaryReader reader) {
            ...
            try {
                ...
                throw new FileParseException("Error reading float32");
            }
        }
        ...
        private static unsafe void getData(BinaryReader reader, byte* buf, int len) {
            ...
            if (len < 1) {
                throw new FileParseException("Error readering xtc file data");
            }
        ...
        static unsafe void xtc_3dfcoord(BinaryReader reader, float[] coords) {
            ...
            *size = lsize;
            ...
            if (*size <= 9) {
                for (i = 0; i < *size; i++) {
                    coords[(3 * i)] = getFloat32(reader);
                    coords[(3 * i) + 1] = getFloat32(reader);
                    coords[(3 * i) + 2] = getFloat32(reader);
                }
                return;
            }
            ...
            fixed(int* ip = new int[ipsize]) {
                ...
                bufsize = (int)(size3 * 1.2) * sizeof(int);
