...
namespace CurtinUniversity.MolecularDynamics.Visualization {
    ...
    public class SecondaryStructureView : MonoBehaviour {
        ...
        public IEnumerator BuildModel(PrimaryStructureFrame frame, SecondaryStructure secondaryStructure) {
            ...
            // create mesh
            if (secondaryStructure != null && Settings.EnableSecondaryStructure) {
                yield return StartCoroutine(createSecondaryStructure(frame, secondaryStructure));
            }
        ...
        private IEnumerator createSecondaryStructure(PrimaryStructureFrame frame, SecondaryStructure secondaryStructure) {
            ...
            for (int i = 0; i < primaryStructure.Chains().Count; i++) {
                ...
                Mesh structureMesh = BuildStructureMesh(chain, frame, secondaryStructure);
                ...
                AddMeshToModel(structure, StructureParent);

                yield return null;
            }
        }

        private Mesh BuildStructureMesh(Chain chain, PrimaryStructureFrame frame, SecondaryStructure secondaryStructure) {
