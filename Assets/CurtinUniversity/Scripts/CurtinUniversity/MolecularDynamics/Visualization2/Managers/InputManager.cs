...
// to fix
                //sceneManager.UserInterface.ReloadOptions();
            }
        ...
        private void handleMouseInput() {
            ...
            if (delta != 0 && !userInterface.IsActive) {
            ...
            if (!userInterface.UIActive() && Input.GetMouseButtonDown(0)) {
        ...
        private void handleKeyboardInput() {
            ...
            if (Input.GetKeyDown(KeyCode.Escape)) {
                userInterface.ToogleUserInterface();
            }
            ...
            if (!userInterface.UIActive() || !userInterface.HasInputFocus()) {
